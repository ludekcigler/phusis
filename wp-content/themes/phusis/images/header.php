...
<div id="wrapper">
	<div class="search" id="<?php if (rand(0, 1) == 0) { echo 'search-phusis'; } else { echo 'search-cygne'; } ?>">
        ...
        <img alt="Phusis" id="print_header" height="160" width="1000" src="<?php bloginfo('template_directory'); ?>/images/cygne_print_michel.png" />
        ...
        <div id="highlight-menu">
            <!-- Zarathustra -->
            <?php 
            $article_list_template = '<li><a href="{url}"><span class="date">{date:d.m.}</span> <span class="title">{title:21:trim}</span></a></li>';
            ...
            <div class="highlight-menu-item">
            <div>
            <h3><a href="http://phusis.ch/michel/pensees-phusiques/">Pensées phusiques</a></h3>
        ...
        <p id="featuredposts"><img alt="&#x1f4fa;" src="<?php bloginfo('template_directory'); ?>/images/television.png" height="16"> <?php get_featured_posts(array('before' => '', 'after' => '', 'max_posts' => 1, 'method' => 'echo')); ?> </p>
        <?php } ?>
	</div>
...
echo $output;
?>            
		    <li class="otherblog"><a href="/steve/">SB | Expérience du vin</a></li>
